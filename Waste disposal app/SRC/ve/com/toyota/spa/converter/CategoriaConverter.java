...
public class CategoriaConverter implements Converter, Serializable {
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String submittedValue) {
		if (submittedValue == null || submittedValue.isEmpty()) {
			...
			try {
				return (SpaCategoria)administracionEJB.getSpaCategoriaFindById(Long.valueOf(submittedValue));
			} catch (Exception e) {
				createMessageFrame(FacesMessage.SEVERITY_ERROR, "Error de validacion.", "Falta seleccionar la categoria, o la seleccionada no es valida.");
			}
			return null;
		}
	}
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object value) {	
		if (!(value instanceof SpaCategoria)) {
			return null;
		} else {
			SpaCategoria spaCategoria = (SpaCategoria)value;
			return String.valueOf(spaCategoria.getIdCategoria());
		}
	}
